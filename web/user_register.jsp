				  		...
				  		<div class="row align-items-center">
				  			...
				  			<div class="col-lg-6 col-sm-6 col-8 header-top-right no-padding">
								<a class="btns" href="tel:+953 012 3654 896">+953 012 3654 896</a>
				  				<a class="btns" href="mailto:support@colorlib.com">support@cuisine.com</a>		
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
						...
						<nav id="nav-menu-container">
                            ...
                            <form class="form-signin" style="margin-top: 80px" action="user_register" method="post">
             <!--<img class="mb-3" src="assets/images/logo.jpg" alt="" width="150" height="120">-->
             <h1 class="h3 mb-3 font-weight-normal" style="margin-left: 50px">Register here!!</h1>
