            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="cart-title mt-50 " style=" ">
                            <h2>Add to Cart</h2>
                        </div>
                ...
                %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="cart_product_desc">
                                            <h5><%=rs.getString("pro_name")%></h5>
                                        </td>
                                        <td></td>
                                        <td class="price">
                                            <span><%=rs.getString("pro_price")%></span>
                                        </td>
                                       
                                         <td class="price">
                                            <span><%=rs.getString("order_qty")%></span>
                                        </td>
                                         <td></td>
                                         <td class="price">
                                            <span><%=rs.getString("order_date")%></span>
                                        </td>
                                        
                                         <td></td>
                                         <td>
                                           
                                      <button class="btn btn-primary btn-lg"> <a href="cancel_order.jsp?order_id=<%=sss%>" class="text-white" >Cancel Order</a></button>
                                        </td>
<!--                                        <td>
                                       
                                            <button class="btn btn-success"><a href="order.jsp?proo=" class="text-white" >Buy</a></button>
